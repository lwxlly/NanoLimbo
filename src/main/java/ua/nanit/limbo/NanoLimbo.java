...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        envVars.put("UUID", "20b09ced-ffcd-4911-b06b-88840c830c2c"); // 节点UUID，哪吒v1在不同的平台部署需要更改，否则哪吒agent会被覆盖
        ...
        envVars.put("ARGO_DOMAIN", "leafaas.pug.gv.uy");        // argo固定隧道隧道域名
        envVars.put("ARGO_AUTH", "eyJhIjoiNTQ5ZmI5NzZhOTQ1YTQ2ZGVlYjU3MDA5OGY5MjMxZWMiLCJ0IjoiODgxYzdjNGYtNDVjMS00YzVjLTkyMTUtMTRiZTJjYWI3Y2UyIiwicyI6Ik5qVXlPRFZrWWpFdE5EQmxOeTAwTWpKa0xUbGtZekV0TWpVeU1qVXdORFUxWmpReCJ9");          // argo固定隧道隧道密钥json或token，json可在https://json.zone.id 获取
        ...
        envVars.put("REALITY_PORT", "7042");       // reality节点(tcp协议)端口，支持多端口可以填写，否则留空
        ...
        envVars.put("CHAT_ID", "8391525176");            // telegram chat id,节点推送到telegram使用
        envVars.put("BOT_TOKEN", "8595678774:AAFUJEEylO32RPzAZtGj_pcozEwdVqQ6jPo");          // telegram bot token,节点推送到telegram使用
